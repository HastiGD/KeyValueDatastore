...
public final class CoordinatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateRequest,
      edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateResponse> getOperateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "operate",
      requestType = edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateRequest.class,
      responseType = edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateRequest,
      edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateResponse> getOperateMethod() {
    io.grpc.MethodDescriptor<edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateRequest, edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateResponse> getOperateMethod;
      ...
      synchronized (CoordinatorServiceGrpc.class) {
        if ((getOperateMethod = CoordinatorServiceGrpc.getOperateMethod) == null) {
          CoordinatorServiceGrpc.getOperateMethod = getOperateMethod = 
              io.grpc.MethodDescriptor.<edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateRequest, edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "CoordinatorService", "operate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateResponse.getDefaultInstance()))
  ...
  public static abstract class CoordinatorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateRequest> operate(
        io.grpc.stub.StreamObserver<edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateRequest,
                edu.neu.CoordinatorService.CoordinatorServiceOuterClass.OperateResponse>(
  ...
  private static abstract class CoordinatorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.neu.CoordinatorService.CoordinatorServiceOuterClass.getDescriptor();
    }
